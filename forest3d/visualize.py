...
def plot_tree_with_widgets():
    ...
    height = FloatSlider(value=75, min=0, max=150, step=1.0, description='height', orientation='vertical')
    ...
    crown_ratio = FloatSlider(value=0.65, min=0, max=1.0, step=0.01, description='crown ratio', orientation='vertical')
    ...
    crown_edge_height_E = FloatSlider(value=45, min=0, max=100, step=1.0, description='east', orientation='vertical')
    crown_edge_height_N = FloatSlider(value=45, min=0, max=100, step=1.0, description='north', orientation='vertical')
    crown_edge_height_W = FloatSlider(value=45, min=0, max=100, step=1.0, description='west', orientation='vertical')
    crown_edge_height_S = FloatSlider(value=45, min=0, max=100, step=1.0, description='south', orientation='vertical')
    shape_top_E = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='top, east')
    shape_top_N = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='top, north')
    shape_top_W = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='top, west')
    shape_top_S = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='top, south')
    shape_bot_E = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='bottom, east')
    shape_bot_N = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='bottom, north')
    shape_bot_W = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='bottom, west')
    shape_bot_S = FloatSlider(value=2.0, min=0.0, max=3.0, step=0.1, description='bottom, south')
    ...
    def on_value_change(*args):
        ...
        new_x, new_y, new_z = make_tree_all_params(species.value,
            dbh.value,
            height.value,
            stem_x.value,
            stem_y.value,
